...
public class Basics {
	...
	public void Test(){
		...
		//https://maps.googleapis.com/maps/api/place/nearbysearch/xml?location=-33.8670522,151.1957362&radius=1500&type=restaurant&keyword=cruise&key=AIzaSyCWg2j-SAAUKIy8rTVK_dPlw7z14kRL7Io
		...
		given().
				...
				//header("Content-Length ", "null").and().
